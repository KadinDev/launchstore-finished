...
const Validate = {
    ...
    // validação criada no create.njk de products
    allFields(e) {
        ...
        for (item of items) {
            if (item.value == ""){
                ...
                message.style.position = 'fixed' // a messagem vai aparecer na tela,
                // e não no comecinho da página
                

                message.innerHTML = 'Todos os campos são obrigatórios.'

                // agora coloca no body
